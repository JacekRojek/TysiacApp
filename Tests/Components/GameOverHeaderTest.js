...
import GameOverHeader from '../../App/Components/GameOverHeader'

const wrapper = shallow(<GameOverHeader />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('GameOverHeader Component')) // That the Component Text is included
})
