...
import PlayersHeader from '../../App/Components/PlayersHeader'

const wrapper = shallow(<PlayersHeader />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('PlayersHeader Component')) // That the Component Text is included
})
