...
import StatisticsRow from '../../App/Components/StatisticsRow'

const wrapper = shallow(<StatisticsRow />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('StatisticsRow Component')) // That the Component Text is included
})
