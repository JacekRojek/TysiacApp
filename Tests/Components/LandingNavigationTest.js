...
import LandingNavigation from '../../App/Components/LandingNavigation'

const wrapper = shallow(<LandingNavigation />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('LandingNavigation Component')) // That the Component Text is included
})
